...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isset($_POST['ID_RequisicionE']) || !isset($_POST['datosTabla'])) {
        ...
        echo 'window.location = "../../../Vista/ALMACENISTA/INSERT/Insert_Salida_ALMACENISTA.php";'; // Reemplaza con la ruta de redirección deseada
        echo '</script>';
        exit();
    }
    ...
    try {
        ...
        echo 'window.location = "../../../Vista/ALMACENISTA/Salidas_ALMACENISTA.php";'; // Reemplaza con la ruta de redirección deseada
        echo '</script>';
        exit();
    } catch (Exception $e) {
