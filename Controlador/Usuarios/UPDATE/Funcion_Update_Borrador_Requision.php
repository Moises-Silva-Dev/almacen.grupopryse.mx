...
require_once("../../../Modelo/Funciones/Funciones_Borrador_RequisicionD.php"); // Funciones para el borrador de requisicionD
require_once("../../../Modelo/Funciones/Funciones_Borrador_RequisicionE.php"); // Funciones para el borrador de requisicionE
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        if (!ActualizarBorradorRequisicionE($conexion, $FchCreacion, $Estatus, $Supervisor, $ID_Cuenta, $Region, $CentroTrabajo, $NroElementos, $Estado, $Receptor, $TelReceptor, $RfcReceptor, $Justificacion, $id_RequisionE)) {
