...
require_once("../../../Modelo/Funciones/Funciones_RequisicionD.php"); // Incluir la clase de funciones para el borrador de requisiciónD
require_once("../../../Modelo/Funciones/Funciones_RequisicionE.php"); // Incluir la clase de funciones para el borrador de requisiciónE
...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0) {
    ...
    try {
        ...
        if (EliminarRequisicionE($conexion, $id_RequisionE)) {
