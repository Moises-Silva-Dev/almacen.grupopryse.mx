...
require_once("../../../Modelo/Funciones/Funciones_EntradaE.php"); // Carga la clase de funciones de la cuenta
...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id']) && is_numeric($_GET['id']) && $_GET['id'] > 0) {
    ...
    try {
        if (ActualizarEstatusEntradaE($conexion, $id_EntradaE)) { // Elimina la cuenta
