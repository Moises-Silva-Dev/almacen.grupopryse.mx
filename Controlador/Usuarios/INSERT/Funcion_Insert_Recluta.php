...
require_once("../../../Modelo/Funciones/Funciones_Recluta.php"); // Funciones para la cuenta
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$nombre || !$ap_paterno || !$ap_materno || !$fecha_nacimiento || !$origen_vacante || 
        !$fecha_envio || !$transferido || !$estado || !$municipio || !$centro_trabajo || 
        !$telefono || !$servicio || !$escolaridad || !$edad || !$transferido_a || 
        !$estatus || !$observaciones || !$reclutador || !$usuario) { // Verificar que los campos no estén vacíos
    ...
    try {
        ...
        if (InsertarNuevoRecluta($conexion, $nombre, $ap_paterno, $ap_materno, $fecha_nacimiento, $origen_vacante, $fecha_envio, $transferido, $estado, $municipio, $centro_trabajo, $telefono, $servicio, $escolaridad, $edad, $transferido_a, $estatus, $observaciones, $registro, $reclutador)) {
