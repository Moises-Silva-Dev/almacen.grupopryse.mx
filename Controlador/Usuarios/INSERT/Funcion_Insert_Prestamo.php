...
require_once("../../../Modelo/Funciones/Funciones_PrestamoE.php"); // Carga la clase de funciones de prestamoE
require_once("../../../Modelo/Funciones/Funciones_PrestamoD.php"); // Carga la clase de funciones de usuarios
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {        
        ...
        $ID_PrestamoE = InsertarNuevoPrestamoE($conexion, $id_Usuario, $FchCreacion, $Justificacion);
        
        if (!$ID_PrestamoE) { // Si la inserción falla, mostrar un mensaje de error
        ...
        if (isset($_POST['datosTabla'])) {
            ...
            if (json_last_error() === JSON_ERROR_NONE) {
                ...
                for ($i = 0; $i < $numFilas; $i++) {
                    ...
                    if (!InsertarNuevoPrestamoD($conexion, $ID_PrestamoE, $idProducto, $idtall, $cant)) {
                        // Si la inserción falla, se lanza una excepción
