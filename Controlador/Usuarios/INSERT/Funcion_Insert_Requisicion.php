...
require_once("../../../Modelo/Funciones/Funciones_RequisicionD.php"); // Carga la clase de funciones de requisionD
require_once("../../../Modelo/Funciones/Funciones_RequisicionE.php"); // Carga la clase de funciones de requisionD
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {        
        ...
        $ID_RequisionE = InsertarNuevaRequisicionEAdmin($conexion, $id_Usuario, $FchCreacion, $Supervisor, $ID_Cuenta, $Region, $CentroTrabajo, $NroElementos, $Estado, $Receptor, $TelReceptor, $RfcReceptor, $Justificacion);
