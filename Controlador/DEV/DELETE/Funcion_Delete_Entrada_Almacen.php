...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['id'])) {
    ...
    echo 'alert("' . $mensaje . '");';
    echo 'window.location = "../../../Vista/DEV/Almacen_Dev.php";'; // Reemplaza con la ruta de redirección deseada
    echo '</script>';
    exit();
} else {
    ...
    echo 'window.location = "../../../Vista/DEV/Almacen_Dev.php";'; // Reemplaza con la ruta de redirección de error deseada
    echo '</script>';
    exit();
}
?>