...
require_once("../../Modelo/Funciones/Funciones_PrestamoE.php"); 
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        if (CambiarEstatusPrestamoE($conexion, $fecha_alta, $idSolicitud)) {
            ...
            $urls = [
                ...
                2 => "../../../Vista/SUPERADMIN/Prestamo_SUPERADMIN.php", // URL para el tipo de usuario 2
