...
-- Fecha de creación: 2025-01-14 09:15:34
-- Host: localhost
-- Usuario: root
...
INSERT INTO `requisicione` VALUES ("32","29","2025-01-08 14:13:58","0000-00-00 00:00:00","Pendiente","Martha Guadalupe Santiago Barron","10","45","Zona Los Rios","455","Martha Guadalupe Santiago Barron","1234567890","Ultrimatrix","fg","2","","","","","");
INSERT INTO `requisicione` VALUES ("33","29","2025-01-08 14:18:14","0000-00-00 00:00:00","Pendiente","Martha Guadalupe Santiago Barron","10","47","Pruebajdbedb","455","Martha Guadalupe Santiago Barron","1234567890","SABM8009293V6","hstgjngmsgmsgm","1","","","","","");
...
-- Trigger `actualizar_inventario_despues_borrar_entrada`
CREATE DEFINER=`root`@`localhost` TRIGGER `actualizar_inventario_despues_borrar_entrada` AFTER DELETE ON `EntradaD` FOR EACH ROW BEGIN
