...
<div class="container mt-5">
    ...
    <!-- Formulario -->
<form id="formGuardar" action="../../../Controlador/USER/UPDATE/Funcion_Update_Solicitud.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="num_tel" name="TelReceptor" value="<?php echo $row['BTelReceptor']  ?>" placeholder="Ingresa el Numero de Telefono del Receptor" required>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="RFC" name="RfcReceptor" value="<?php echo $row['BRfcReceptor']  ?>" placeholder="Ingresa el RFC del Receptor">
                <div class="invalid-feedback">
            ...
            <br>
                ...
                <input type="text" class="form-control" id="CP" name="CP" value="<?php echo $row['BCP']  ?>" placeholder="Ingresa el Codigo Postal">
                <div class="invalid-feedback">
