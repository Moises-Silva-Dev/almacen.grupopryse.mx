...
<body>
    <div class="container">
        ...
        <nav class="navbar-horizontal">
            <div class="logo">
                <p><a style="color: white" href="index_USER.php">Inicio</a></p>
            </div>
        ...
        <nav class="navbar-vertical" id="navbar-vertical">
            ...
            <ul>
                <li><a href="Solicitud_USER.php"><i class="fas fa-clipboard-list"></i>Requisiciones</a></li>
                <li><a href="Ver_USER.php"><i class="fas fa-eye"></i>Ver Requisiciones</a></li>
            </ul>
        </nav>
        <main class="main-content">
            <canvas style="background: white;" id="graficaRequisiciones" width="800" height="600"></canvas>
        </main>
    </div>
