...
if (isset($_GET['id']) && !empty($_GET['id'])) {  
    ...
    if ($row = $resultado->fetch_assoc()) {
        ...
        $query = "SELECT BIDRequisicionE, IMG, Nombre_Empresa, Descripcion, Especificacion, Descrp, Talla, BCantidad
