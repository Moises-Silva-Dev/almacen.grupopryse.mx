...
<div class="container mt-5">
    <center><h2>Registrar Nuevo Borrador</h2></center>
<!-- Formulario -->
<form action="../../../Controlador/USER/INSERT/Funcion_Insert_Solicitud.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Supervisor" name="Supervisor" placeholder="Ingresa el Nombre del Supervisor" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || 
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Receptor" name="Receptor" placeholder="Ingresa el Nombre del Receptor" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || 
                   (event.charCode >= 97 && event.charCode <= 122) || 
                   event.charCode == 209 || event.charCode == 241 || 
                   event.charCode == 32)" required>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="num_tel" name="num_tel" placeholder="Ingresa el Numero de Telefono del Receptor" onkeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" required>
                <div class="invalid-feedback">
            ...
            <br>
                ...
                <input type="text" class="form-control" id="CP" name="CP" maxlength="5" placeholder="Ingresa el Codigo Postal" onkeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;">
                <div class="invalid-feedback">
