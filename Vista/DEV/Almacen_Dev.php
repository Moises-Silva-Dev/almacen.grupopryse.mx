                        ...
                        <div class="col-md-8 mb-3 mb-md-0">
                            <form method="GET" action="" class="search-form">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control form-control-lg border-navy" name="search" placeholder="Buscar por proveedor o receptor..." value="<?php echo htmlspecialchars($search ?? ''); ?>" aria-label="Buscar usuarios">
                                    <?php if (empty($search)): ?>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="py-3 px-4 border-bottom border-navy text-navy">
                                        <i class="fas  me-2"></i>Proveedor
                                    </th>
                                    <th class="py-3 px-4 border-bottom border-navy text-navy">
                                        <i class="fas  me-2"></i>Receptor
                                    </th>
                                    <th class="py-3 px-4 border-bottom border-navy text-navy">
                            ...
                            <tbody>
                                <?php
                                    try {
                                        ...
                                        if (!empty($search)) {
                                            $searchTerm = "%$search%";
                                            $sql .= " AND (EE.Proveedor LIKE ? OR EE.Receptor LIKE ?) 
                                        ...
                                        if (!empty($search)) {
                                            $sql_total .= " AND
                                            (EE.Proveedor LIKE ? OR EE.Receptor LIKE ?)";
                                        }
                                ...
                                <tr class="border-bottom border-light">
                                    <td class="py-3 px-4">
                                        <div class="form-check">
                                            <input class="form-check-input user-checkbox" type="checkbox" value="<?php echo $row['IdEntE']; ?>">
                                        </div>
                                    </td>
                                    <td class="py-3 px-4">
                                        <span class="badge bg-navy rounded-pill">#<?php echo $row['IdEntE']; ?></span>
                                    </td>
                                    <td class="py-3 px-4">
