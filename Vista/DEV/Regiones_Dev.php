                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            ?>
                                <tr class="table-light">
                                    ...
                                    <td>
                                        <a class="btn btn-warning" href="Update/Update_Region_Dev.php?id=<?php echo $row['ID_Region']; ?>">
                                    ...
                                    <td>
                                        <a class="btn btn-danger" onclick="return eliminar()" 
                                        href="../../Controlador/DEV/DELETE/Funcion_Delete_Region.php?id=<?php echo $row['ID_Region']; ?>">
