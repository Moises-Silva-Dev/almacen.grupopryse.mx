            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-0 text-navy">
                        ...
                        Administra las Equipos 
                    </h1>
                </div>
                <!-- Botón para abrir modal -->
                <button type="button" class="btn btn-primary" onclick="openEquipoModal()">
                                ...
                                <?php
                                    try {
                                        ...
                                        $sql = "SELECT 
                                                ...
                                                FROM Control_Equipos CE 
                                                INNER JOIN Departamento D ON CE.ID_Departamento = D.Id
                                                WHERE 1=1";
                                        ...
                                        $sql .= " ORDER BY CE.Id DESC LIMIT ? OFFSET ?";

                                        // Calcular total para paginación (incluyendo búsqueda)
                                        $sql_total = "SELECT COUNT(*) as total FROM Control_Equipos CE";
                                        ...
                                        if (!empty($search)) {
                                            ...
                                            $stmt->bind_param("sssssii", 
                                                $searchTerm, $searchTerm, $searchTerm, $searchTerm, $searchTerm, $records_per_page, $offset
                                            );
                                        } else {
                                ...
                                <tr>
                                    <td colspan="8" class="py-5 text-center">
                                        <div class="empty-state">
                                            ...
                                            <h5 class="text-navy">No se encontraron equipos</h5>
                                            <p class="text-muted">
