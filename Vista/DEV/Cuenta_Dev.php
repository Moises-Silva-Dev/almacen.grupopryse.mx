...
<center><div class="table-responsive">
        <h2 class="mb-4">Cuentas Registrados</h2>
            <!-- Botones -->
        ...
        <table class="table table-hover table-striped mt-4" class="table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM Cuenta LIMIT $records_per_page OFFSET $offset;";
                
                $query = mysqli_query($conexion, $sql);
                
                // Total de registros
                $sql_total = "SELECT COUNT(*) FROM Cuenta";
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <tr class="table-light">
                        ...
                        <td><?php echo $row['NroElemetos']; ?></td>
                        <td><a class="btn btn-warning" href="Update/Update_Cuenta_Dev.php?id=<?php echo $row['ID']; ?>">
                        ...
                        <td><a class="btn btn-danger" onclick="return eliminar()" href="../../Controlador/DEV/DELETE/Funcion_Delete_Cuenta.php?id=<?php echo $row['ID']; ?>">
