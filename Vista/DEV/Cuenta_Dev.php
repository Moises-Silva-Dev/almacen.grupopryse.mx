...
<div class="table-responsive">
    <center>
        ...
        <!-- Botones -->
        <a class="btn btn-primary" href="INSERT/Insert_Cuenta_Dev.php">
    ...
    <table class="table table-hover table-striped mt-4">
        <thead class="table-light">
            <tr>
                ...
                <th scope="col">Numero de Elementos</th>
        ...
        <tbody>
            <?php
                try {
                    ...
                    $sql_total = "SELECT COUNT(*) FROM Cuenta"; // Consulta para obtener el total de registros
                    ...
                    while ($row = mysqli_fetch_array($query)) { // Iterar sobre los resultados de la consulta
                        $id = htmlspecialchars($row['ID'], ENT_QUOTES, 'UTF-8'); // Escapar los datos para prevenir XSS
                        $NombreCuenta = htmlspecialchars($row['NombreCuenta'], ENT_QUOTES, 'UTF-8'); // Escapar los datos para prevenir XSS
                        $NroElemetos = htmlspecialchars($row['NroElemetos'], ENT_QUOTES, 'UTF-8'); // Escapar los datos para prevenir XSS
            ?>
                    <tr class="table-light">
                        <td><?php echo $id; ?></td>
                        <td><?php echo $NombreCuenta; ?></td>
                        <td><?php echo $NroElemetos; ?></td>
                        <td>
                            <a class="btn btn-warning" href="Update/Update_Cuenta_Dev.php?id=<?php echo $id; ?>">
                        ...
                        <td>
                            <a class="btn btn-danger" onclick="eliminarRegistroCuenta(<?php echo $id; ?>)" href="javascript:void(0);">
