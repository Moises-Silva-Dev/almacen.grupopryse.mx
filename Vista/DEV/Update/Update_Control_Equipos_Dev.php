<!-- Modal para Modificar Control de Equipos -->
<div class="modal fade" id="modificarEquipoModal" tabindex="-1" aria-labelledby="modificarEquipoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header bg-navy text-white">
                <h5 class="modal-title" id="modificarEquipoModalLabel">
                    <i class="fas fa-edit me-2"></i>
                    Modificar Control de Equipo
                </h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            
            <div class="modal-body">
                <div id="loadingModificarEquipoData" class="text-center py-5">
                ...
                <div id="modificarEquipoFormContainer" style="display: none;">
                    <form id="FormUpdateControlEquipo" action="../../../Controlador/Usuarios/UPDATE/Funcion_Update_Control_Equipo.php" method="POST" novalidate>
                        <input type="hidden" name="Id" id="edit_equipo_id">
                        
                        <!-- Sistema de navegación por círculos -->
                        <div class="step-indicator-container">
                            <div class="step-indicator">
                                <div class="step-circle" id="edit_equipo_stepCircle1">
                                    <span class="step-number">1</span>
                                    <i class="fas fa-check step-check"></i>
                                </div>
                                <div class="step-line" id="edit_equipo_stepLine1-2"></div>
                                <div class="step-circle" id="edit_equipo_stepCircle2">
                                    <span class="step-number">2</span>
                                    <i class="fas fa-check step-check"></i>
                                </div>
                                <div class="step-line" id="edit_equipo_stepLine2-3"></div>
                                <div class="step-circle" id="edit_equipo_stepCircle3">
                                    <span class="step-number">3</span>
                                    <i class="fas fa-check step-check"></i>
                                </div>
                            </div>
                            <div class="step-labels">
                                <div class="step-label" id="edit_equipo_stepLabel1">
                                    <i class="fas fa-user"></i>
                                    <span>Asignación</span>
                                </div>
                                <div class="step-label" id="edit_equipo_stepLabel2">
                                    <i class="fas fa-microchip"></i>
                                    <span>Especificaciones</span>
                                </div>
                                <div class="step-label" id="edit_equipo_stepLabel3">
                        ...
                        <!-- PASO 1: Asignación -->
                        <div id="edit_equipo_step1" class="form-step">
                        ...
                        <div id="edit_equipo_step2" class="form-step" style="display: none;">
                            <div class="card border-navy mb-4">
                                <div class="card-header bg-light text-navy">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="edit_equipo_Modelo_Equipo" class="form-label text-navy">
                                                <i class="fas fa-tag me-1 text-turquoise"></i>
                                                Modelo del Equipo
                                            </label>
                                            <input type="text" class="form-control border-navy" id="edit_equipo_Modelo_Equipo" name="Modelo_Equipo" 
                                                   placeholder="Ingresa el modelo">
                                        </div>
                                        
                                        <div class="col-md-6 mb-3">
                                            <label for="edit_equipo_Numero_Serie" class="form-label text-navy">
                                                <i class="fas fa-barcode me-1 text-turquoise"></i>
                                                Número de Serie
                                            </label>
                                            <input type="text" class="form-control border-navy" id="edit_equipo_Numero_Serie" name="Numero_Serie" 
                                                   placeholder="Ingresa el número de serie">
                                            <small class="text-muted">El número de serie debe ser único en el sistema</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox" id="edit_equipo_Tiene_Grafica_Dedicada" name="Tiene_Grafica_Dedicada" value="1">
                                                <label class="form-check-label text-navy" for="edit_equipo_Tiene_Grafica_Dedicada">
                                    ...
                                    <div class="row" id="edit_equipo_Datos_Grafica_Div" style="display: none;">
                                        <div class="col-md-12 mb-3">
                                            <label for="edit_equipo_Datos_Tarjeta_Grafica" class="form-label text-navy">
                                                <i class="fas fa-video me-1 text-turquoise"></i>
                                                Datos de la Tarjeta Gráfica
                                            </label>
                                            <input type="text" class="form-control border-navy" id="edit_equipo_Datos_Tarjeta_Grafica" name="Datos_Tarjeta_Grafica" 
                        ...
                        <div id="edit_equipo_step3" class="form-step" style="display: none;">
                            <div class="card border-navy mb-4">
                                <div class="card-header bg-light text-navy">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="edit_equipo_Camara_Web" class="form-label text-navy">
                                                <i class="fas fa-camera me-1 text-turquoise"></i>
                                                Cámara Web
                                            </label>
                                            <select class="form-select border-navy" id="edit_equipo_Camara_Web" name="Camara_Web">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="edit_equipo_Otro_Periferico" class="form-label text-navy">
                                                <i class="fas fa-usb me-1 text-turquoise"></i>
                                                Otros Periféricos
                                            </label>
                                            <textarea class="form-control border-navy" id="edit_equipo_Otro_Periferico" name="Otro_Periferico" 
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <label for="edit_equipo_Observaciones" class="form-label text-navy">
                                                <i class="fas fa-comment me-1 text-turquoise"></i>
                                                Observaciones
                                            </label>
                                            <textarea class="form-control border-navy" id="edit_equipo_Observaciones" name="Observaciones" 
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button type="button" class="btn btn-secondary" id="edit_equipo_prevBtn" style="display: none;">
                            ...
                            <div>
                                ...
                                <button type="button" class="btn btn-navy" id="edit_equipo_nextBtn">
                                    Siguiente <i class="fas fa-arrow-right ms-1"></i>
                                </button>
                                <button type="button" class="btn btn-primary" id="edit_equipo_submitBtn" style="display: none;">
...
<!-- JS -->
<script src="../../../js/Formularios/Formulario_Actualizar_Control_Equipos.js"></script>