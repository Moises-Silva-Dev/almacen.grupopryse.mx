...
<div class="container mt-5">
    ...
    <!-- Formulario -->
<form id="formGuardar" action="../../../Controlador/DEV/UPDATE/Funcion_Update_Solicitud.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="num_tel" name="TelReceptor" value="<?php echo $row['TelReceptor']  ?>" placeholder="Ingresa el Numero de Telefono del Receptor" required>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="RFC" name="RfcReceptor" value="<?php echo $row['RfcReceptor']  ?>" placeholder="Ingresa el RFC del Receptor" required>
                <div class="invalid-feedback">
            ...
            <br>
                ...
                <input type="text" class="form-control" id="CP" name="CP" value="<?php echo $row['CP']  ?>" placeholder="Ingresa el Codigo Postal">
                <div class="invalid-feedback">
...
<br>    
            ...
            <div class="mb-3">
                ...
                <a href="../Solicitud_Dev.php" class="btn btn-danger">
