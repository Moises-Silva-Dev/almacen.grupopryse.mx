...
<center><h2>Modificar Usuario</h2></center>
    ...
    <form id="FormUpdateUsuario" class="needs-validation" action="../../../Controlador/Usuarios/UPDATE/Funcion_Update_Usuario.php" method="post" enctype="multipart/form-data" novalidate>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="apellido_materno" name="apellido_materno" value="<?php echo $row['Apellido_Materno']  ?>">
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="num_tel" name="num_tel" value="<?php echo $row['NumTel']  ?>" required>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="num_contacto_sos" name="num_contacto_sos" value="<?php echo $row['NumContactoSOS']  ?>" required>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            <label for="Opcion" class="form-label">¿Deseas Cambiar su Contraseña?</label>
            <select class="form-select" id="Opcion" name="Opcion" required onchange="toggleContrasena()">
        ...
        <!-- Elementos que deben mostrarse solo si se selecciona "SI" -->
        <div id="contrasenaContainer" style="display: none;">
            <!-- Contraseña -->
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    <input type="password" class="form-control" id="valcontrasena" name="valcontrasena" placeholder="Ingresa la contraseña">
                    <div class="invalid-feedback">
