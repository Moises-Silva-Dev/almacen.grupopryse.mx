...
<div class="container mt-5">
    ...
    <!-- Formulario -->
    <form action="../../../Controlador/DEV/INSERT/Funcion_Insert_Salida.php" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
...
<div class="table-responsive">
    <table class="table table-sm table-dark" id="tablaProductos">
        <thead>
            <tr>
                <th scope="col">#</th>
        ...
        <tbody>
            ...
            ?>
                    <tr scope="row">
                        ...
                        <td><input type="hidden" class="form-control" name="Id_Talla[]" id="Id_Talla[]" value="<?php echo $row1['Identificador_Talla']; ?>"></td>
            ...
            <!-- Botones -->
            <div class="mb-3">
                <button id="botonGuardar" type="submit" class="btn btn-primary" onclick="guardarDatosTabla()">
                ...
                <a href="../Salidas_Dev.php" class="btn btn-danger">
