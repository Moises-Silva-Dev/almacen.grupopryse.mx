...
<div class="container mt-5">
    ...
    <!-- Formulario -->
    <form id="FormInsertProductoNuevo" class="needs-validation" action="../../../Controlador/Usuarios/INSERT/Funcion_Insert_Producto.php" method="post" enctype="multipart/form-data" novalidate>
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea id="Descripcion" name="Descripcion" class="form-control" placeholder="Ingresa la Descripción del Producto" required></textarea>
            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <select class="form-select mb-3" id="IdCTipTall" name="IdCTipTall" required>
...
<script src="../../../js/SweetAlertNotificaciones/Notificacion_SweetAlert_Insertar_Producto.js"></script>
