...
<div class="container mt-5">
    ...
    <!-- Formulario -->
<form action="../../../Controlador/DEV/INSERT/Funcion_Insert_Solicitud.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
    ...
    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="CentroTrabajo" name="CentroTrabajo" placeholder="Ingresa el Nombre del Centro de Trabajo" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 32)" required>
                <div class="invalid-feedback">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="RFC" maxlength="13" name="RFC" placeholder="Ingresa el RFC del Receptor" required>
                <div class="invalid-feedback">
