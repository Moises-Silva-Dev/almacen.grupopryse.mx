                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger <?php echo $tieneRegistros ? 'disabled' : ''; ?>" href="../../Controlador/DEV/DELETE/Funcion_Delete_Usuario.php?id=<?php echo $row['ID_Usuario']; ?>" onclick="return <?php echo $tieneRegistros ? 'false' : 'eliminar()'; ?>">
