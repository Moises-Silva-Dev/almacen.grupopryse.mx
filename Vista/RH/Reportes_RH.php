...
<h2 class="text-center">REPORTES</h2> 
    ...
    <!-- Formulario de Solicitud -->
    <details class="accordion">
        <summary class="accordion-btn">Reporte Filtrar Reclutas</summary>
        <div class="accordion-content">
            <div class="row">
                <div class="col-md-6">
                    <div class="formulario-panel formulario-izquierdo">
                        <form id="reclutasFormFiltro" class="needs-validation" novalidate>
                            <div class="mb-3">
                                <label for="filtrar" class="form-label">Filtrar por:</label>
                            ...
                            <!-- Campos dinámicos -->
                            <div id="campo-nombres" class="mb-3" style="display: none;">
                                <label for="nombre" class="form-labe">Ingresa Nombre o Apellidos:</label>
                                <input type="text" id="nombre" name="nombre" class="form-control" >
                            </div>
                            <div id="campo-estatus" class="mb-3" style="display: none;">
                                <label for="estatus" class="form-label">Selecciona Estatus:</label>
                            ...
                            <div id="campo-reclutador" class="mb-3" style="display: none;">
                                <label for="reclutador" class="form-label">Ingresa Reclutador:</label>
                                <input type="text" id="reclutador" name="reclutador" class="form-control">
                            </div>

                            <center>
                                <button type="button" id="btnGenerarPDF" class="btn-custom" onclick="Generar_PDF_Filtro_Reclutas(event)">
                                    <span class="bgContainer"><span>Generar PDF</span></span>
                                    <span class="arrowContainer">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-type-pdf" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                ...
                                <button type="button" id="btnGenerarExcel" class="btn-custom" onclick="Generar_Excel_Filtrar_Reclutas(event)">
                                    <span class="bgContainer"><span>Generar Excel</span></span>
                                    <span class="arrowContainer">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-file-type-xls" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
    ...
    <div class="modal fade" id="pdfModalSalidaID" tabindex="-1" aria-labelledby="pdfModalLabel" aria-hidden="true">
        ...
        <!-- Modal de Filtro Reclutas -->
    <div class="modal fade" id="pdfModalFiltrarReclutas" tabindex="-1" aria-labelledby="pdfModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="pdfModalLabel">Reporte Filtrar Reclutas</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <iframe id="pdfIframeFiltrarReclutas" width="100%" height="500px"></iframe>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                </div>
...
<script src="../../js/LimpiaFormularioRecluta.js"></script>
...
<script src="../../js/PDF/GenerarPDFFiltrarReclutas.js"></script>
...
<script src="../../js/EXCEL/GenerarExcelFiltrarReclutas.js"></script>
