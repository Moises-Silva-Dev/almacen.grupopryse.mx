            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <tr class="table-light">
                        ...
                        <td><a class="btn btn-warning" href="Update/Update_Entrada_Almacen_ALMACENISTA.php?id=<?php echo $row['IdEntE']; ?>">
                        ...
                        <td><a class="btn btn-danger" onclick="return eliminar()" href="../../Controlador/ALMACENISTA/DELETE/Funcion_Delete_Entrada_Almacen.php?id=<?php echo $row['IdEntE']; ?>">
