                        ...
                        <div class="col-md-8 mb-3 mb-md-0">
                            <form method="GET" action="" class="search-form">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control form-control-lg border-navy" name="search" placeholder="Buscar por identificador o solicitante..." value="<?php echo htmlspecialchars($search ?? ''); ?>" aria-label="Buscar usuarios">
                                    <?php if (empty($search)): ?>
                            ...
                            <tbody>
                                <?php
                                    try{
                                        ...
                                        if (!empty($search)) {
                                            $searchTerm = "%$search%";
                                            $sql .= " AND (PE.IdPrestamoE LIKE ? OR U.Nombre LIKE ? OR U.Apellido_Paterno LIKE ? OR U.Apellido_Materno LIKE ?) 
                                            AND (PE.Estatus='Autorizado')";
                                        }
                                        ...
                                        if (!empty($search)) {
                                            $sql_total .= " AND (PE.IdPrestamoE LIKE ? OR U.Nombre LIKE ? OR U.Apellido_Paterno LIKE ? OR U.Apellido_Materno LIKE ?)
                                ...
                                <tr class="border-bottom border-light">
                                    ...
                                    <td class="py-3 px-4">
                                        <span class="badge bg-light text-navy">
                                            ...
                                            <?php echo htmlspecialchars($row['FchCreacion']); ?>
                                        </span>
                                    </td>
                                    <td class="py-3 px-4">
                                        <span class="badge bg-light text-navy">
                                    ...
                                    <td class="py-3 px-4">
                                        <div class="d-flex justify-content-center gap-2">
                                            <!-- Botón Editar -->
                                            <button class="btn btn-sm btn-outline-navy" onclick="insertPrestamoAlmacenista(<?php echo $row['IdPrestamoE']; ?>)" title="Registrar Prestamo">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <small class="text-muted">
                                    ...
                                    de <strong><?php echo $total_rows; ?></strong> prestamos
                                </small>
                            </div>
