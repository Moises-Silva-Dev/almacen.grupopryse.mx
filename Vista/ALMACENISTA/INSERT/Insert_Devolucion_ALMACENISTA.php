...
<div class="container mt-5">
    <center><h2>Registrar Devolución</h2></center>
    <form id="FormInsertDevolucionNueva" class="needs-validation" action="../../../Controlador/Usuarios/INSERT/Funcion_Insert_Devolucion.php" method="post" enctype="multipart/form-data" novalidate>
            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <div class="mb-3">
                            <label for="Opcion" class="form-label"><span style="color: red;">*</span> ¿Que tipo de Solicitud es?</label>
                        ...
                        <div id="Solicitud" class="mb-3" style="display: none;">
                            <label for="Mpio" class="form-label">Numero de Requisición o Prestamo:</label>
                            <input type="text" class="form-control" id="Identificador" name="Identificador" placeholder="Ingresa el Identicador" onkeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;">
                            <div class="invalid-feedback">
                                Por favor, ingresa el Municipio.
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="Proveedor" class="form-label">Nombre de quien Devuelve:</label>
                            <input type="text" class="form-control" id="Nombre_Devuelve" name="Nombre_Devuelve" placeholder="Ingresa el Nombre del quien Devuelve" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122) || event.charCode == 32)" required>
                            <div class="invalid-feedback">
                                Por favor, Ingresa el Nombre del Proveedor.
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="Receptor" class="form-label">Telefono de quien Devuelve:</label>
                            <input type="text" class="form-control" id="Telefono_Devuelve" name="Telefono_Devuelve" placeholder="Ingresa el Telefono del quien Devuelve" onkeypress="if (event.keyCode < 48 || event.keyCode > 57) event.returnValue = false;" required>
                            <div class="invalid-feedback">
        ...
        <div class="mb-3">
            ...
            <a href="../Almacen_ALMACENISTA.php" class="btn btn-danger">
...
<script src="../../../js/Form_Devolucion.js"></script>
<script src="../../../js/Insert_Devolucion_datosTabla.js"></script>
<script src="../../../js/Busqueda_Entrada_Productos.js"  defer></script>
<script src="../../../js/VistaTablaProductos.js"></script>
<script src="../../../js/SweetAlertNotificaciones/Notificacion_SweetAlert_Insertar_Devolucion.js"></script>
