...
<body>
    <div class="container">
        ...
        <nav class="navbar-horizontal">
            <div class="logo">
                <p><a style="color: white" href="index_ALMACENISTA.php">Inicio</a></p>
            </div>
        ...
        <nav class="navbar-vertical" id="navbar-vertical">
            ...
            <ul>
                ...
                <li><a href="Devolucion_ALMACENISTA.php"><i class="fas fa-undo"></i>Devoluciones</a></li>
        ...
        <main class="main-content">
            ...
            <canvas style="background: white;" id="graficaEntrada" width="800" height="600"></canvas>
        </main>
    </div>
    <script src="../../js/Notificacion_Alert_Inventario.js"></script>
    <script src="../../js/Graficas/GraficaControEntradaDia.js"></script>
</body>
</html>
