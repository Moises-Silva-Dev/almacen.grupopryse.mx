            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    <tr class="table-light">
                        ...
                        <td><a class="btn btn-warning" href="Update/Update_Producto_ALMACENISTA.php?id=<?php echo $row['IdCProducto']; ?>">
                        ...
                        <td><a class="btn btn-danger" onclick="return eliminar()" href="../../Controlador/ALMACENISTA/DELETE/Funcion_Delete_Producto.php?id=<?php echo $row['IdCProducto']; ?>">
                        ...
                        <td><a class="btn btn-success" href="Visualizar/Imagen.php?id=<?php echo $row['IdCProducto']; ?>">
