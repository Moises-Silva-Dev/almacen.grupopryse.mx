...
<div class="table-responsive">
    <center>
        ...
        <!-- Botones -->
        <a class="btn btn-primary" href="INSERT/Insert_Producto_ALMACENISTA.php">
        ...
        <tbody>
            ...
            ?>
                        <tr class="table-light">
                            ...
                            <td><a class="btn btn-warning" href="Update/Update_Producto_ALMACENISTA.php?id=<?php echo $IdCProducto; ?>">
                            ...
                            <td><a class="btn btn-danger" onclick="eliminarRegistroProducto(<?php echo $IdCProducto; ?>)" href="javascript:void(0);">
                            ...
                            <td><a class="btn btn-success" onclick="mostrarProducto(<?php echo $IdCProducto; ?>)">
            ...
            <?php
                    ...
                    echo "<div class='alert alert-danger'>Ocurrió un error al procesar la solicitud. Por favor, inténtelo de nuevo más tarde.</div>"; // Mostrar un mensaje de error genérico al usuario
                } finally {
