...
<html lang="es">
<head>
    <title>Dashboard - Almacenista</title>
    <meta charset="UTF-8">
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                <ul>
                    <li>
                        <a href="Producto_ALMACENISTA.php" class="menu-item">
                            <i class="fas fa-store menu-icon"></i>
                            <span class="menu-text">Productos</span>
                        </a>
                    </li>
                    <li>
                        <a href="Almacen_ALMACENISTA.php" class="menu-item">
                            <i class="fas fa-boxes menu-icon"></i>
                            <span class="menu-text">Entrada de Productos</span>
                        </a>
                    </li>
                    <li>
                        <a href="Salidas_ALMACENISTA.php" class="menu-item">
                            <i class="fas fa-dolly menu-icon"></i>
                    ...
                    <li>
                        <a href="Reportes_ALMACENISTA.php" class="menu-item">
