                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <th class="py-3 px-4 border-bottom border-navy text-navy">
                                        <i class="fas fa-comments me-2"></i>Comentario para Modificación
                                    </th>
                            ...
                            <tbody>
                                <?php
                                    try {
                                        ...
                                        $sql = "SELECT 
                                                BRE.BIDRequisicionE, DATE(BRE.BFchCreacion) AS Fecha, BRE.BEstatus, C.NombreCuenta, BRE.BCentroTrabajo, 
                                        ...
                                        if (!empty($search)) {
                                            $sql_total .= " AND (BRE.BIDRequisicionE LIKE ?) AND (U.Correo_Electronico = ?)";
                                        }
                            ...
                            <tr class="border-bottom border-light">
                                    ...
                                    <td class="py-3 px-4">
                                        <span class="badge bg-navy rounded-pill">#<?php echo $row['BIDRequisicionE']; ?></span>
                                    </td>
                                    <td class="py-3 px-4">
                                    ...
                                    <td class="py-3 px-4">
                                        <span class="badge bg-secondary">
                                            <?php echo htmlspecialchars($row['BEstatus']); ?>
                                        </span>
                                    </td>
                                    <td class="py-3 px-4">
                                        <span class="badge bg-light text-navy">
