...
<body>
    <div class="container">
        ...
        <nav class="navbar-horizontal">
            <div class="logo">
                <p><a style="color: white" href="index_ADMIN.php">Inicio</a></p>
            </div>
        ...
        <nav class="navbar-vertical" id="navbar-vertical">
            ...
            <ul>
                ...
                <li><a href="Requisicion_ADMIN.php"><i class="fas fa-edit"></i>Modificacion Productos Requisición</a></li>
        ...
        <main class="main-content">
            <canvas style="background: white;" id="graficaRequisicionesXusuario" width="800" height="600"></canvas>
        </main>
    </div>
    <script>
