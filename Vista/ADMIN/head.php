    ...
    <div class="dashboard-container">
        ...
        <nav class="navbar-top">
            <div class="navbar-brand">
                ...
                <a href="index_ADMIN.php" class="nav-home-link">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-menu">
                <ul>
                    <li>
                        <a href="Solicitud_ADMIN.php" class="menu-item">
                    ...
                    <li>
                        <a href="Ver_ADMIN.php" class="menu-item">
                            <i class="fas fa-eye menu-icon"></i>
                            <span class="menu-text">Ver Requisiciones</span>
                        </a>
                    </li>
                    <li>
                        <a href="Reportes_ADMIN.php" class="menu-item">
