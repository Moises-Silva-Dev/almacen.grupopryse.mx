...
<div class="container mt-5">
    ...
    <!-- Formulario -->
<form id="formGuardar" action="../../../Controlador/ADMIN/UPDATE/Funcion_Update_Solicitud.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
