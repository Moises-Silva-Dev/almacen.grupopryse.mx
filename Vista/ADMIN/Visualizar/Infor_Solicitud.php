...
<div class="container mt-5">
    ...
    <!-- Formulario -->
    <form action="../../../Controlador/Usuarios/INSERT/Funcion_Insert_Requisicion_Original.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
