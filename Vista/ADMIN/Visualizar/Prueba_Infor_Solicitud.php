...
<div class="container mt-5">
    ...
    <!-- Formulario -->
    <form id="FormularioEnviarRequisicion" action="../../../Controlador/Usuarios/INSERT/Prueba_Funcion_Insert_Requisicion_Original.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
