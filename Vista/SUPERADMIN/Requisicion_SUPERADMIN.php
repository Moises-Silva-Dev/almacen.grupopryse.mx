                        ...
                        <div class="col-md-8 mb-3 mb-md-0">
                            <form method="GET" action="" class="search-form">
                                <div class="input-group input-group-lg">
                                    ...
                                    <input type="text" class="form-control form-control-lg border-navy" name="search" placeholder="Buscar por identificador, nombre, cuenta..." value="<?php echo htmlspecialchars($search ?? ''); ?>" aria-label="Buscar usuarios">
                                    <?php if (empty($search)): ?>
                            ...
                            <tbody>
                                <?php
                                    try {
                                        ...
                                        if (!empty($search)) {
                                            $sql_total .= " AND (RE.IDRequisicionE LIKE ? OR C.NombreCuenta LIKE ?) AND (U.Correo_Electronico = ?)";
                                        }
                                        ...
                                        if (!empty($search)) {
                                            $searchTerm = "%$search%";
                                            $stmt->bind_param("ssssii", $usuario, $searchTerm, $searchTerm, $usuario, $records_per_page, $offset);
                                        } else {
