...
const AgregarRegionConEstado = document.getElementById("btn_AgregarRegionConEstado");
...
const datosTablaInput = document.getElementById("datosTablaInsertRegion");
...
AgregarRegionConEstado.addEventListener("click", function() {
