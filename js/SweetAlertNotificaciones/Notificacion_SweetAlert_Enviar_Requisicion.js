...
document.getElementById('FormularioEnviarRequisicion').addEventListener('submit', function (e) {
    ...
    fetch(e.target.action, { // La URL del formulario está en el atributo "action"
        ...
        .then(data => { // Maneja la respuesta del servidor
            if (data.success === true) { // Si el servidor indica que el inicio de sesión fue exitoso
                Swal.fire({
