...
document.getElementById('FormInsertSalidaPrestamoNueva').addEventListener('submit', function (e) {
    // Primero, verifica si los datos de la tabla son válidos
    const datosGuardados = guardarDatosTabla();
    if (!datosGuardados) {
        e.preventDefault(); // Detiene el envío del formulario si no hay datos válidos
        return;
    }
