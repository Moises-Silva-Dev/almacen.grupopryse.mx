...
document.getElementById('FormInsertBorradorRequisionNueva').addEventListener('submit', function (e) {
    ...
    if (datosTablaInput.value === "[]") { // Verifica si no se han agregado estados
        Swal.fire({
            ...
            title: "Sin productos agregados", // Título del mensaje
            text: "Por favor, agregue al menos un producto antes de enviar el formulario."
        });
