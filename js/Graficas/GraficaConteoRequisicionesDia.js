...
async function cargarDatosMes() {
    try {
        const respuesta = await fetch('../../Controlador/GET/Graficas/getGraficaRequisicionXDia.php');
...
async function cargarDatosSemana() {
    try {
        const respuesta = await fetch('../../Controlador/GET/Graficas/getGraficaRequisicionXSemana.php');
        const datos = await respuesta.json();
