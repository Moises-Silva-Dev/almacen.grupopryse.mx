...
async function cargarDatos(usuario) {
    try {
        ...
        const respuesta = await fetch('../../Controlador/GET/getGraficaRequisicionXusuarioXDia.php?idUsuario=' + usuario);
        ...
        const ctx = document.getElementById('graficaRequisicionesXusuario').getContext('2d'); 
        new Chart(ctx, {
