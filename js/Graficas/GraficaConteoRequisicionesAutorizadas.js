...
async function cargarDatos() {
    try {
        ...
        const respuesta = await fetch('../../Controlador/GET/getGraficaRequisicionAutorizadaXDia.php');
        ...
        const ctx = document.getElementById('graficaRequisicionesAutorizadas').getContext('2d'); 
        new Chart(ctx, {
            ...
            data: { // Configura los datos de la gráfica
                ...
                datasets: [{ // Conjunto de datos para la gráfica
                    label: 'Autorizadas por día', // Etiqueta del conjunto de datos
            ...
            options: { // Configura las opciones de la gráfica
                ...
                plugins: { // Configura los plugins de la gráfica
                    ...
                    title: { // Configura el título de la gráfica
                        ...
                        text: 'Total de Requisiciones Autorizadas del mes' // Texto del título
                    }
                },
